...
DESCOPE_DISCOVERY_URL="YOUR_DESCOPE_ISSUER_URL"
```
...
- `DESCOPE_DISCOVERY_URL`: can be found in your Descope's account under the [Applications page](https://app.descope.com/applications) and editing the active application  
